...
public class JsonUtil {
    private static List<JsonObject> sortBigDecimalsArray(JsonArray array, String sortKey) {
    ...
    private static List<JsonObject> sortStringJsonArray(JsonArray array, String sortKey) {
        List<JsonObject> sorted = new ArrayList<>();
    ...
    public static List<JsonObject> sortJsonArray(JsonArray array, String sortKey) {
